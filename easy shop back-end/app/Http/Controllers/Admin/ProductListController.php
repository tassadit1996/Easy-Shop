...
class ProductListController extends Controller
{
    ...
    public function StoreProduct(Request $request){
        ...
        $save_url = 'https://easy-shop.tassadit-maghni.com/api1/upload/product/'.$name_gen;
    ...
    $save_url1 = 'https://easy-shop.tassadit-maghni.com/api1/upload/productdetails/'.$name_gen1;


    $image2 = $request->file('image_two');
    $name_gen2 = hexdec(uniqid()).'.'.$image2->getClientOriginalExtension();
    Image::make($image2)->resize(711,960)->save('upload/productdetails/'.$name_gen2);
    $save_url2 = 'https://easy-shop.tassadit-maghni.com/api1/upload/productdetails/'.$name_gen2;
    ...
    $save_url3 = 'https://easy-shop.tassadit-maghni.com/api1/upload/productdetails/'.$name_gen3;
    ...
    $save_url4 = 'https://easy-shop.tassadit-maghni.com/api1/upload/productdetails/'.$name_gen4;
